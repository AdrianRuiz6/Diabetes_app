...
namespace Master.Presentation.PetCare.Log
{
    public class UI_GraphLog : MonoBehaviour
    {
        ...
        private void PlotGraph()
        {
            ...
            float yMaximum = _petCareLogManager.currentAttributeFilter == AttributeType.Glycemia ? 250f : 100f; // Valor máximo en el eje vertical.
        ...
        private void PlotDataPoints()
        {
            ...
            float yMaximum = _petCareLogManager.currentAttributeFilter == AttributeType.Glycemia ? 250f : 100f;
            ...
            foreach (AttributeLog dataPoint in _currentAttributeLog)
            {
                ...
                int limitMinutes = (currentHour == _settingsManager.finishTime.Hours) ? 59 : 60;
