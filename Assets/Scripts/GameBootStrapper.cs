...
namespace Master
{
    ...
    public class GameBootStrapper : MonoBehaviour
    {
        ...
        private void InitializeServices()
        {
            ...
            _scoreManager = new ScoreManager(_scoreRepository, _connectionManager);
            ...
            _questionManager = new QuestionManager(_questionRepository, _userPerformanceManager, _connectionManager);
            _petCareLogManager = new PetCareLogManager(_petCareRepository);
            _petCareManager = new PetCareManager(_chatBot, _petCareRepository, _petCareLogManager, _scoreManager, _scoreLogManager, _economyManager, _connectionManager);
